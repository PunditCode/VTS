...
//RUS: 행惟靭粧寮猖鎭 衆抑策姮?增尊有, 嚴泣 述 張 町陝寮暢鎭 尿禎蟻吾循潗 膣意寥 秧 凞諺孼桎?靭長
...
//RUS: 찰調純外陝猥 惟葬凹?膣意寥?剪狀茁鎭蟻狀 凞諺孼診 靭長
...
public:
	...
	void HideTooltip();
	BOOL IsShow() { return m_nTooltipState == PPTOOLTIP_STATE_SHOWING || m_nTooltipState == PPTOOLTIP_STATE_SHOWN; }
