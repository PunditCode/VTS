...
public:
	...
	void SetSkin(LPCTSTR normal,LPCTSTR down, LPCTSTR over=0, LPCTSTR disabled=0, LPCTSTR focus=0, COLORREF crTransparent = -1,
...
protected:
	...
	CImage m_bNormal,m_bDown,m_bDisabled,m_bOver,m_bFocus; //skin bitmaps
	 CBrush   m_Brush;
