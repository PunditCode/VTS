...
// Attributes
	void SetSelectTabColor(COLORREF color) { m_crSelectTab = color; }
	void SetNoneSelectTabColor(COLORREF color) { m_crNoneSelectTab = color; }
	void SetTextColor(COLORREF color) { m_crTextColor = color; }
	void SetSelectTextColor(COLORREF color) { m_crTextColorSel = color; }
public:

protected:
	DWORD m_dwCustomLook;
	COLORREF m_crSelectTab, m_crNoneSelectTab;
	COLORREF m_crTextColorSel, m_crTextColor;
// Operations
public:
