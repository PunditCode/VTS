...
VTSOptionsHoga::VTSOptionsHoga(void) 
{
	SER()->UnregisterHoga(m_pCode, mt_default, this);
}

BOOL VTSOptionsHoga::RunRecv()
{
...
BOOL VTSOptionsHoga::OnInitReceive(CHAR* pPacket, UINT nDataLength)
{
...
BOOL VTSOptionsHoga::OnReceive(CHAR* pPacket, UINT nDataLength)
{
	LPOH0_OutBlock p = (LPOH0_OutBlock)pPacket;
